...
extension/lib/             # naming.js / dedupe.js / gifEncoder.js / apngEncoder.js
                           # — UMD, shared by worker, sidepanel and tests
extension/offscreen.html   # + offscreen.js: MP4→.gif / MP4→APNG conversion
                           # (chrome.runtime ONLY — re-added in v3.13, quality
                           # + chunked relay in v3.14; no archive code)
...
## 4. Current architecture (v3.14.0)
