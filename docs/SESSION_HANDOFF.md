...
_Latest input (2026-09-03, third brief):_ the file name still ended up as
...
to avoid duplications**. Shipped in v3.10 — see the new IMPROVEMENT_LOG entry.
