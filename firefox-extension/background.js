// ==========================================================================
// background.js — Firefox port for X Media Downloader
// Handles: auth, GraphQL API, media extraction, queue, direct downloads.
// (Firefox MV2 has no chrome.offscreen, so MP4→GIF conversion degrades to
// the original MP4 clip on this port — see README known limitation.)
// ==========================================================================
...
// silent MP4 clip; a real .gif (maximum quality), an animated
